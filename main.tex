...
\setcounter{section}{2} %skip counter for first sections
\input{chapters/3_postulate.tex}
\input{chapters/4_das_freie_teilchen.tex}
\input{chapters/5_schroedinger_gleichung.tex}
\input{chapters/6_1d_systeme.tex}
\input{chapters/7_zentralkraftproblem.tex}
\input{chapters/8_symmetrien.tex}
\input{chapters/9_naeherungsmethoden.tex}
